...
- [Download Describe Screenshot](https://www.icloud.com/shortcuts/af56833cf5904e349688ec3a6696b6cf)
- [Download Describe Photo](https://www.icloud.com/shortcuts/ad970f82e7f24ffaa46032a17822efc8)
...
4. **Greater Control and Customization**: The Shortcuts offer more control over your interactions with the AI. For example, you can customize the AI's writing style, language, and other advanced parameters to better suit your needs and preferences. This level of customization is not available with Be My Eyes.
...
8. VoiceOver may have a bug where it doesn't recognize the table correctly at first. Stop interacting with the table and re-interact with it to resolve this issue.
...
Once installed, this shortcut will accept photos from the share sheet or macOS quick actions. Unfortunately, it will only accept one image. I will consider adding support for multiple shared images if there is enough demand, but I decided against it early on because sharing several images can get pricy.
